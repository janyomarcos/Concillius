$(function () {
    ...
    var getValidationSummaryErrors = function ($form) {
        ...
        var errorSummary = $form.Busca('.validation-summary-errors, .validation-summary-valid');
            ...
            .done(function (content) {
                dialogs[id] = $('<div class="modal-popup">' + content + '</div>')
                    ...
                    .dialog({ // Create the jQuery UI dialog
                        ...
                        beforeClose: function () { resetForm($(this).Busca('form')); }
                    })
                    .Busca('form') // Attach logic on forms
